    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if MİN_BET <= amount <= MAX_BET:
                ...
                print(f"Bet must be between ${MİN_BET} - ${MAX_BET}!")
        else:
            print("Please enter a number!")
    return amount
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have enough to bet that ampunt, your current balance is ${balance}")
        else:
            break    
...
def main():
    ...
    while True:
        ...
        answer = input("Press enter to play spin (q to quit).")
        if answer == "q":
            break
